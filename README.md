This repository contains four MATLAB functions to define ROI, measure MFI and format acquired data designed for fluorescent microarray readout from uMAP.
...
Combine_Median: a function to combine medians from excel files generated by roi_grid_measure_tool
  ...
  process_excel_files: a function to calculate the column-wise mean and reorganize the data layout of excel file generated by Combine_Median to improve efficiency when visualizing the data. Not required by the workflow.
  input: an excel file generated by Combine_Median
  output: an excel file containing processed mean of the medians
